...
public class Frame extends JFrame implements ActionListener {
	...
	private final ImageIcon imageSearch = new ImageIcon("images/Search.png");
	...
	private final Color COLOR_BORDER = Color.gray;
	...
	private JPanel pnlCenterWest = new JPanel();
	private JPanel pnlCenterMain = new JPanel();
	private JLabel lblMenuName = new JLabel(" 문제집");
	private ImageButton btnSearch = new ImageButton(imageSearch, 50);
	...
	public Frame() {
		...
		ImageButton[] aryImageButton = {
				btnSearch, btnSort, btnAddWorkbook,
				btnWorkbook, btnReview, btnHistory, btnSetting
				};
		...
		for (int i=3; i<aryImageButton.length; i++) {
			...
			JLabel lblTemp = new JLabel(aryButtonName[i-3], SwingConstants.CENTER);
		...
		pnlCenterWest.setPreferredSize( new Dimension(80, 0) );
	...
	public void actionPerformed(ActionEvent e) {
		...
		//상단 메뉴
		if (strMenu == "Workbook") {
			if ( source.equals(btnSearch) ) { //검색
				dlgWbSearch.setVisible(true);
			}
